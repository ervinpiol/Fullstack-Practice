...
const AuthProvider = ({ children })=>{
    ...
    // 👇 Public pages where user SHOULD NOT be redirected
    const publicRoutes = [
        "/auth/login",
        "/auth/signup"
    ];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function checkAuth() {
            // If user is on a public page → skip redirect
            if (publicRoutes.includes(pathname)) {
                setLoading(false);
                return;
            }
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$axios$40$1$2e$13$2e$2$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:8000/auth/me", {
                    withCredentials: true
                });
                setUser(res.data);
            } catch (error) {
                router.replace("/auth/login"); // redirect when NOT logged in
            } finally{
                setLoading(false);
            }
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d4e53f47._.js.map