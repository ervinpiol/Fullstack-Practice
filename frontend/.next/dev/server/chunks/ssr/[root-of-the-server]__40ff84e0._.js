...
function CartProvider({ children }) {
    ...
    const fetchCartItems = async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$axios$40$1$2e$13$2e$2$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:8000/cart/items", {
    ...
    // Add a product to the cart (fixed for duplicates)
    const addToCart = async (productId, quantity = 1)=>{
        try {
            ...
            if (existingItem) {
                ...
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$axios$40$1$2e$13$2e$2$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:8000/cart/items/${existingItem.id}`, {
                ...
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$axios$40$1$2e$13$2e$2$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:8000/cart/items", {
                    product_id: productId,
                    quantity
                }, {
                    withCredentials: true
    ...
    const updateQuantity = async (cartItemId, productId, quantity)=>{
        ...
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$axios$40$1$2e$13$2e$2$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:8000/cart/items/${cartItemId}`, {
                product_id: productId,
                quantity
            }, {
                withCredentials: true
    ...
    const removeItem = async (cartItemId, productId)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$axios$40$1$2e$13$2e$2$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:8000/cart/items/${cartItemId}`, {
                data: {
                    product_id: productId
                },
                withCredentials: true
...
// Import the hook to get the current URL path
...
function Header() {
    ...
    // Helper function to define the common class names
    const baseClasses = "font-medium";
    // Helper function to determine the text color based on the current path
    const getLinkClasses = (href)=>{
        // If the current pathname matches the link's href, apply the active style
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        children: [
                            ...
                            itemCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "absolute top-1 right-0 w-4 h-4 bg-primary text-primary-foreground rounded-full text-xs font-bold flex items-center justify-center",
                                children: itemCount
                            }, void 0, false, {
                                fileName: "[project]/components/header.tsx",
                                lineNumber: 47,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__40ff84e0._.js.map